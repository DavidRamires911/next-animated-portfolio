  ...
  >
    <div className="h-[600vh] relative" ref={ref}>
      <div className="w-screen h-[calc(100vh-6rem)] flex flex-col gap-40 items-center justify-center text-8xl text-center">
        My Works
        <motion.svg
      initial={{ opacity: 0.2, y: 0 }} // Start with a visible opacity
      animate={{ 
        opacity: [0.3, 0.8, 0.3], // Smooth opacity transition
        y: ["0px", "10px", "0px"]
      }}
      transition={{
        repeat: Infinity,
        ...
        <motion.div style={{ x }} className="flex">
          ...
          {Projects.map((project) => (
            <div
              ...
              key={project.id}
            >
              <div className="flex flex-col   gap-8 lg:gap-0  text-white  ">
                <h1 className="text-xl font-bold md:text-4xl lg:text-6xl xl:text-8xl">
                  {project.title}
                </h1>
                <div className="relative w-56 h-56 md:w-96 md:h-80  lg:w-[500px] lg:h-[350px] xl:w-[700px] xl:h-[720px]">
